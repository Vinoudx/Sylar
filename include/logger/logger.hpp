...
#define LOG(level) \
            std::make_unique<sylar::LoggerWapper>(sylar::LogLevel::level, sylar::Logger::ptr_t(new sylar::Logger), sylar::LogEvent::ptr_t(new sylar::LogEvent(__FILE__, __LINE__, sylar::getThreadId(), sylar::getFiberId(), time(0))))->getSS()

#define SYLAR_LOG_DEBUG LOG(DEBUG)
#define SYLAR_LOG_INFO LOG(INFO)
#define SYLAR_LOG_WARNING LOG(WARNING)
#define SYLAR_LOG_ERROR LOG(ERROR)
#define SYLAR_LOG_FATAL LOG(FATAL)
